...
public class FileStorage extends AbstractStorage<File> {
    ...
    protected void updateElement(Resume r, File file) {
        try {
            streamSerializer.writeElement(r, new BufferedOutputStream(new FileOutputStream(file)));
        } catch (IOException e) {
    ...
    protected Resume getElement(File file) {
        try {
            return streamSerializer.readElement(new BufferedInputStream(new FileInputStream(file)));
        } catch (IOException e) {
