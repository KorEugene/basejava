        ...
        try (DataOutputStream dos = new DataOutputStream(os)) {
            ...
            writeCollection(dos, r.getSections().entrySet(), entry -> {
                ...
                switch (type) {
                    ...
                    case ACHIEVEMENT:
                    case QUALIFICATIONS:
                        writeCollection(dos, (((ListSection) section).getElementsOfSection()), dos::writeUTF);
                        break;
                    case EXPERIENCE:
                    case EDUCATION:
                        writeCollection(dos, (((OrganizationSection) section).getOrganizations()), org -> {
                            dos.writeUTF(org.getWebPage().getTitle());
                            dos.writeUTF(org.getWebPage().getUrl());
            ...
            case EDUCATION:
                return new OrganizationSection(
                        readList(dis, () -> new Organization(
                                new HyperLink(dis.readUTF(), dis.readUTF()),
